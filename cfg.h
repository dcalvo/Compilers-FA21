...
enum OperandKind {
	...
	OPERAND_MREG_MEMREF_OFFSET_INDEX = (OPROP_HAS_BASEREG | OPROP_HAS_INDEXREG | OPROP_HAS_INTVAL | OPROP_IS_MEMREF) +
	10,
	// integer literal
...
public:
	...
	using EdgeMap = std::map<BasicBlock*, EdgeList>;
